"""
Django settings for contio_backend project.
...
SECRET_KEY = 'django-insecure-5+=qqohq0rb8r7qvi&ah!=8^vd^k5bdy5z%k6=vihk2rg_dvk@'
...
EMAIL_HOST_PASSWORD = 'baah ezuj ancm jdfx'
